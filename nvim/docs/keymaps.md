...
| 快捷键 | 模式 | 说明 | 来源 |
|--------|------|------|------|
| `<C-1>` | 普通/终端 | 切换文件浏览器 (NvimTree) | file-explorer |
| `<C-2>` | 普通/终端 | 切换 Claude Code | claudecode |
| `<C-3>` | 普通/终端 | 切换底部终端 (30% 高度) | snacks |
| `<C-\`>` | 普通/终端 | 切换窗口焦点 | basic (内置) |
...
| 快捷键 | 模式 | 说明 | 来源 |
|--------|------|------|------|
| `<C-2>` | 普通/终端 | 切换 Claude | claudecode |
...
| 快捷键 | 模式 | 说明 | 来源 |
|--------|------|------|------|
| `<C-1>` | 普通/终端 | 切换文件浏览器 (NvimTree) | nvim-tree |
